...
Star_Trek:RequireModules("control", "button", "lcars")

Star_Trek.Control_Console = Star_Trek.Control_Console or {}
...
local setupButton = function()
	if IsValid(Star_Trek.Control_Console.Button) then
		Star_Trek.Control_Console.Button:Remove()
	end
	...
	Star_Trek.Control_Console.Button = ent
end

hook.Add("InitPostEntity", "Star_Trek.Control_Console.SpawnButton", setupButton)
hook.Add("PostCleanupMap", "Star_Trek.Control_Console.SpawnButton", setupButton)